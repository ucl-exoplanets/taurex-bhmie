from taurex.contributions import Contribution, contribute_tau
import numpy as np
from taurex.data.fittable import fitparam
from taurex_bhmie.external.mie import bh_mie
...
class BHMieContribution(Contribution):
    ...
    def __init__(self, mie_path=None, mie_type='cloud', bh_particle_radius=1.0,
        ...
        if mie_path is None:
            self._mie_path = pkg_resources.resource_filename('taurex_bhmie','MgSiO3.dat')
